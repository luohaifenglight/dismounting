...
typedef QHash<QString, GLC_World *> modelEntryHash;
//////////////////////////////////////////////////////////////////////
//! \class FileEntry
...
public:
	...
	//! Set the GLC_3DViewInstance of this file entry
	void setWorld(QString worldName);
	//! 复制World
	void duplicateWorld(QString srcWorld,QString dstWorld);

	//! 提取occurence,生成world,插入到m_modelEntryHash
	bool ExtractOccurence(QString srcWorld, QString OccurenceName);
...
private:
	...
	//拆解模型列表
	modelEntryHash m_modelEntryHash;
};
